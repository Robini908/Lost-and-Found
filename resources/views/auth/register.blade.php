<x-guest-auth>
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gradient-to-br from-gray-50 to-gray-100"
        ...
        <!-- Loading State -->
        <x-loading-state message="Creating your account..." />
        ...
        <div class="w-full sm:max-w-md mt-6 px-8 py-8 bg-white shadow-[0_8px_30px_rgb(0,0,0,0.08)] backdrop-blur-sm bg-white/90 overflow-hidden sm:rounded-3xl border border-gray-100">
            <div class="text-center mb-8">
                ...
                <h2 class="text-2xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 text-transparent bg-clip-text">Create Account</h2>
            ...
            <form method="POST" action="{{ route('register') }}"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <x-input id="name" class="block mt-1 w-full pl-10 border-gray-200 focus:border-indigo-500 focus:ring-indigo-500 rounded-xl shadow-sm transition duration-200" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" />
                    </div>
                </div>
                ...
                <div class="mt-4">
                    ...
                    <div class="relative">
                        ...
                        <x-input id="email" class="block mt-1 w-full pl-10 border-gray-200 focus:border-indigo-500 focus:ring-indigo-500 rounded-xl shadow-sm transition duration-200" type="email" name="email" :value="old('email')" required autocomplete="username" />
                    </div>
                </div>
                    ...
                    <div class="mt-4">
                        <x-label for="terms">
                            <div class="flex items-center">
                                <x-checkbox name="terms" id="terms" required class="rounded text-indigo-600 focus:ring-indigo-500" />
                                <div class="ms-2 text-sm text-gray-600">
                                    {!! __('I agree to the :terms_of_service and :privacy_policy', [
                                            'terms_of_service' => '<a target="_blank" href="'.route('terms.show').'" class="text-indigo-600 hover:text-indigo-800 transition duration-200">'.__('Terms of Service').'</a>',
                                            'privacy_policy' => '<a target="_blank" href="'.route('policy.show').'" class="text-indigo-600 hover:text-indigo-800 transition duration-200">'.__('Privacy Policy').'</a>',
                                    ]) !!}
                                </div>
                            </div>
                        </x-label>
                ...
                <div class="mt-6">
                    <div class="bg-gray-50 rounded-xl p-4 shadow-sm border border-gray-100">
                        <div class="mb-2">
                            <h3 class="text-sm font-medium text-gray-700">Verify you're human</h3>
                            <p class="text-xs text-gray-500">Please complete the verification below to proceed</p>
                        </div>
                        <x-recaptcha />
                    </div>
                </div>
